...
## Setting up DVWS
Set the MySQL hostname, username, password and an existing database name in the ```/app/includes/connect-db.php``` file then go to Setup to finish setting up DVWS.
